...
import { getRedisConnection, getLLMQueue, getEmailQueue } from './queues'
 ...
 */
async function publishStatus(redis: ReturnType<typeof getRedisConnection>, jobId: string, event: object) {
